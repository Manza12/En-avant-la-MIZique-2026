...
# =============================================================================
# TERNARY TEXTURES  (base unit: 1/24)
# =============================================================================

# Binary originals → nearest 1/24 equivalent
# 1/16 = 1.5/24 → 2/24  (ligeramente redondeado)
# 2/16 = 3/24
# 3/16 = 4/24  (approx, exacto sería 4.5/24)  → 5/24 también válido
# 4/16 = 6/24
# 1/32 = 0.75/24 → 1/24

R_1_1 = Rhythm(Hit('0', '5/24'), Hit('5/24', '3/24'), Hit('8/24', '4/24'))
R_1_2 = Rhythm(Hit('2/24', '4/24'), Hit('6/24', '3/24'), Hit('9/24', '3/24'))
R_2 = Rhythm(Hit('0/24', '5/24'), Hit('5/24', '7/24'))
R_3 = Rhythm(Hit('2/24', '1/24'), Hit('3/24', '3/24'), Hit('6/24', '6/24'))
R_5 = Rhythm(Hit('0/24', '2/24'), Hit('2/24', '3/24'), Hit('5/24', '7/24'))
R_6_1 = Rhythm(Hit('0/24', '2/24'), Hit('3/24', '2/24'), Hit('6/24', '2/24'), Hit('9/24', '2/24'))
R_6_2 = Rhythm(Hit('2/24', '1/24'), Hit('5/24', '1/24'), Hit('8/24', '1/24'), Hit('11/24', '1/24'))
R_7_1 = Rhythm(Hit('0/24', '2/24'), Hit('5/24', '1/24'), Hit('8/24', '1/24'), Hit('11/24', '1/24'))
R_7_2 = Rhythm(Hit('2/24', '1/24'), Hit('3/24', '2/24'), Hit('6/24', '2/24'), Hit('9/24', '2/24'))
R_8_1 = Rhythm(Hit('5/24', '1/24'), Hit('8/24', '1/24'), Hit('11/24', '1/24'))
R_8_2 = Rhythm(Hit('0/24', '2/24'), Hit('2/24', '1/24'), Hit('3/24', '2/24'), Hit('6/24', '2/24'), Hit('9/24', '2/24'))
R_9 = Rhythm(Hit('0/24', '2/24'), Hit('3/24', '3/24'), Hit('8/24', '1/24'), Hit('9/24', '3/24'))
R_10 = Rhythm(Hit('0/24', '2/24'), Hit('3/24', '3/24'), Hit('8/24', '4/24'))

t_1 = Texture(R_1_1, R_1_1, R_1_2, R_1_2, R_1_2)
t_2 = Texture(R_2, R_2, R_2, R_2, R_2)
t_3 = Texture(R_3, R_3, R_3, R_3, R_3)
t_4 = Texture(
    Rhythm(Hit('0', '1/2')),
    Rhythm(Hit('2/24', '1/24'), Hit('11/24', '1/24')),
    Rhythm(Hit('3/24', '2/24'), Hit('9/24', '2/24')),
    Rhythm(Hit('5/24', '1/24'), Hit('8/24', '1/24')),
    Rhythm(Hit('6/24', '2/24'))
)
t_5 = Texture(R_5, R_5, R_5, R_5, R_5)
t_6 = Texture(R_6_1, R_6_1, R_6_2, R_6_2, R_6_2)
t_7 = Texture(R_7_1, R_7_1, R_7_2, R_7_2, R_7_2)
t_8 = Texture(R_8_1, R_8_1, R_8_2, R_8_2, R_8_2)
t_9 = Texture(R_9, R_9, R_9, R_9, R_9)
t_10 = Texture(R_10, R_10, R_10, R_10, R_10)
t_11 = Texture(
    Rhythm(Hit('0', '1/2')),
    Rhythm(Hit('2/24', '1/24'), Hit('8/24', '1/24')),
    Rhythm(Hit('3/24', '2/24'), Hit('9/24', '2/24')),
