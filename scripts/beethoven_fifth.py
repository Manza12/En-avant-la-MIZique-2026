...
ot_1 = (t_main_head * (t_half * frac(3*4+1, 4))) @ (s_violin * 2)
ot_2 = ((t_main_head * (t_half * frac(2*4+2, 4))) + frac(1, 2)) @ (s_viola * 2)
ot_3 = ((t_main_head * (t_half * frac(1*4+2, 4))) + frac(2, 2)) @ (s_violin * 2)
...
sf2_path = sound_fonts_paths['FluidR3_GM2-2']
