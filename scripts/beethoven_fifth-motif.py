...
m_2_piano = (t_main_2 @ (octave_4 + h_2)) @ s_piano
...
plot_notes(piece, figsize=(4, 2), x_tick_start=0, x_tick_step=frac(1, 2), y_tick_step=1)  # , color_by_instrument=True
