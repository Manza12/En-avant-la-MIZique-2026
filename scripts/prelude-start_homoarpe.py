...
R_1 = Rhythm(Hit('0/48', '24/48'))
R_2 = Rhythm(Hit('1/48', '23/48'))
R_3 = Rhythm(Hit('2/48', '22/48'))
R_4 = Rhythm(Hit('3/48', '21/48'))
R_5 = Rhythm(Hit('4/48', '20/48'))
...
piece = bars[0] * bars[1] * bars[2] * bars[3] * bars[4] * bars[5] * bars[6] * bars[7]
