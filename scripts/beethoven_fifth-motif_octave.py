...
h_1 = Harmony(dominant | (dominant - 12) | (dominant - 24) | (dominant - 36),
              mediant | (mediant - 12) | (mediant - 24) | (mediant - 36))
...
m_1_piano = (t_main_1 @ (octave_4 + h_1)) @ s_piano
...
name = 'beethoven_fifth-motif_octave'
...
plot_notes(piece, figsize=(4, 2), x_tick_start=0, x_tick_step=frac(1, 2), y_tick_step=4)  # , color_by_instrument=True
