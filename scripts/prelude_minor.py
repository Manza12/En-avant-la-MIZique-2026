...
dominant     = Chord({7})    # G
submediant   = Chord({8})    # A
subtonic     = Chord({10})    # Bb
...
h6  = h(tonic,        supertonic,    subdominant,   submediant,    up(supertonic))   # D: C D F# A D
...
h10 = h(supertonic_1, submediant_1,  supertonic,    subdominant,   up(tonic))        # D7: D A D F# C
h11 = h(dominant_1,   leading_tone_1,supertonic,    dominant,      leading_tone)     # G: G B D G B
h12 = h(dominant_1,   flat_seventh_1,mediant+1,     dominant,      up(flat_second))  # E7: G Bb E G C#

h13 = h(subdominant_1,submediant_1+1,  supertonic,    submediant+1,    up(supertonic))   # Dm: F A D A D
...
h20 = h(tonic_1,      dominant_1,    flat_seventh_1,tonic,         mediant+1)          # C7: C3 G3 Bb3 C4 E4
...
h28 = h(dominant_2,   flat_third_1,  submediant_1+1,  tonic,         tritone)          # D7: G2 Eb3 A3 C4 F#4
...
h32 = h(tonic_2,      tonic_1,       dominant_1,    flat_seventh_1,mediant+1)          # dim: C2 C3 G3 Bb3 E4
